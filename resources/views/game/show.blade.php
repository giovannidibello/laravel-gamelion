...
<div class="container">
    ...
    <div class="d-flex justify-content-around mb-2 border rounded p-2 bg-light">
        @if ($game->cover_image)
  ...
  <div class="d-flex justify-content-between mb-2 border rounded p-2">
    <h6 class="mb-0"><strong>Data di pubblicazione: </strong>{{ $game->release_date }}</h6>
